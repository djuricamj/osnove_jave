...
//Dana (dan.mesec.godina.)god sklopljen je ugovor izmedju (print prodavca) i (print kupca) o kupovini nekretnine (adresa) po ceni od (cena nekretnin) pri cemu je kupac u obavezi da agenciji isplati novcanu vrednost u iznosu od (zarada agencije)
        ...
        FizickoLice prodavac = new FizickoLice("Ivan Ivanovic", "00387653", "0212988715062", true);

        FizickoLice kupac = new FizickoLice("Milica Milic", "00753626", "0107995329754", false);

        Ugovor ugovor = new Ugovor("09.08.2023.", prodavac, kupac, 90000, "Kralja Petra 21, Novi Sad");
