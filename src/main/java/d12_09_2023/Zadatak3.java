...
//    Naravno u glavnom kreirati objekte i testirati funkcionalnosti
    ...
    public static void main(String[] args) {
        Racun posiljalac = new Racun("170-634738292-23", "Dimitrije Dimitrijevic", 50000);
        Racun primalac = new Racun("170-637829463-23", "Natasa Stoiljkovic", 35000);
        Transakcija uplata = new Transakcija(66, posiljalac, primalac );
       uplata.izvrsiTransakciju(5000);
