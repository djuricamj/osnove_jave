...
//        1 Test passed.
        ...
        if (actualUrl.equals(expectedUrl) && errorCode.equals("URL_MISSMATCH")){
            System.out.println("1 Test passed");
        }else System.out.println("Assertion Error: Expected " + expectedUrl + "but got " + actualUrl + ", error code: " + errorCode);
